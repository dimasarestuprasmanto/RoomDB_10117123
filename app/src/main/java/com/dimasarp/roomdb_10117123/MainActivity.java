package com.dimasarp.roomdb_10117123;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        aktivisEntity.setNamaAktivis("Dimas Arestu Prasmanto");
        aktivisEntity.setEmailAktivis("dimas.arestu99@gmail.com");
        ...
        Log.e("ZONE","===================");
        aktivisEntityListByZone = db.aktivisDao().findByZone("Dumai");
